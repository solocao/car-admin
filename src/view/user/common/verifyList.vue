    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          key: 'car_model',
          render: (h, params) => {
            const { car_name } = params.row.car_model;
            return <div>
              {car_name}
            </div>
          }
        ...
        },
        {
          ...
          render: (h, params) => {
            ...
            let stateText = '未认证';
            switch (state) {
              case 0: stateText = '未认证'; break;
              case -1: stateText = '认证不通过'; break;
              case 1: stateText = '认证通过'; break;
              case 2: stateText = '未认证'; break;
              default: stateText = '未认证'; break;
            }
            return <div>
              {stateText}
            </div>
